...
| Operating systems | Interpreter (`xenly`) | Native compiler (`xenlyc`) | Bytecode compiler (`xenlyc` and `xenly`) |
|:-----------------:|:---------------------:|:--------------------------:|:----------------------------------------:|
| Linux             | Yes                   | Yes                        | No                                       |
| Apple macOS       | Yes                   | Yes                        | No                                       |
| Windows Subsystem for Linux | Yes         | Yes                        | No                                       |
| Windows           | No                    | No                         | Yes                                      |
